...
export class HomePage {
    ...
    constructor(public state: State, public http: HttpClient, public modalController: ModalController, private fb: FormBuilder) {
    }
    ...
    async searchForPrices(persons: number | undefined) {
        ...
        const result = await firstValueFrom(this.http.get<TaxiDTO>(environment.baseURL + "/TaxaApis/GetTaxaPrices/" + timeAndDistance.distance + "," + timeAndDistance.time + "," + persons))
