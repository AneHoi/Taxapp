...
public class GlobalExceptionHandler
{
        ...
        ILogger<GlobalExceptionHandler> logger)
    {
                 ...
                 exception is NotImplementedException)
        {
            ...
            return http.Response.WriteAsJsonAsync(new ResponseDto<dynamic> { MessageToClient = "Unable to process request" });
        }
        else
        {
        ...
        return http.Response.WriteAsJsonAsync(new ResponseDto<dynamic>
        {
            MessageToClient = exception.ToString()
        });
    }
}